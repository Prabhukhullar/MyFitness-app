...
public class ContactRecViewAdapter extends RecyclerView.Adapter<ContactRecViewAdapter.ViewHolder> {
    ...
    public void setContacts(ArrayList<Contact> contacts) {
        ...
        // if i want to scrap data from website and if they will update data and then i also change
        // data so for that i used below one.
        notifyDataSetChanged();
    }



    // That ViewHolder hold the view of every item.
